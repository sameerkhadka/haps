...
class ProjectController extends VoyagerBaseController{
    public function index(Request $request)
    {
        ...
        $dataTypeContent = $dataTypeContent->where('category_id',$request->category_id)->except(1);
        $isBasic = true;
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_tagging')) {
            if (auth()->user()->can('browse', $data)) {
                ...
                return Redirect::to('/admin/projects?category_id=' . $request->category_id);
            } else {
    ...
    public function destroy(Request $request, $id)
    {
        ...
        return Redirect::to('/admin/projects?category_id=' . $category_id)->with($data);
    }
    ...
    public function order(Request $request)
    {
        ...
        $results = $query->orderBy($dataType->order_column, $dataType->order_direction)->where('category_id',$request->category_id)->get();
